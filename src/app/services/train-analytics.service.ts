...
export class TrainAnalyticsService {
    ...
    getTasksSummary(fromTime: string, toTime: string) {
        ...
        return this.http
            .get(this.baseUrl + 'api/custom/tasks-summary', { params })
            .pipe(
                catchError((err) => {
    ...
    getTasks(
        ...
        return this.http
            .get(this.baseUrl + 'api/custom/tasks-paginated', { params })
            .pipe(
                catchError((err) => {
                    console.error(
    ...
    getTaskAnalysis(projectId: string, taskId: string) {
        ...
        return this.http
            .get(this.baseUrl + 'api/custom/task-analysis', { params })
            .pipe(
                catchError((err) => {
    ...
    getTaskComments(taskId: string) {
        return this.http
            .get(this.baseUrl + `api/custom/tasks/${taskId}/comments/?org=`)
            .pipe(
                catchError((err) => {
    ...
    deleteTaskComment(commentId: string) {
        return this.http
            .delete(this.baseUrl + `api/custom/comments/${commentId}`)
            .pipe(
                catchError((err) => {
                    console.error('Error: Failed to delete task comment', err);
                    return throwError(() => err);
                })
            );
    }
